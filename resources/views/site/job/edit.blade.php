  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    @enderror
      ...
      <div class="col-md-4">
        ...
        <input type="text" id="wait_return" name="wait_return" value="{{ old('wait_return', $job->wait_return) }}" class="form-control"  />
        @error('wait_return')
      <div class="mt-2 text-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="col-md-4">
        ...
        <input type="text" id="return_time" name="return_time" value="{{ old('return_time', $job->return_time) }}" class="form-control"  />
        @error('return_time')
      <div class="mt-2 text-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="col-md-4">
        ...
        <input type="text" id="destination_time" name="destination_time"  value="{{ old('destination_time', $job->destination_time) }}" class="form-control"  />
    ...
    @enderror
      ...
      <input type="text" name="addresses[]" class="form-control" placeholder="Address" value="{{ $address }}"
      required />
      @if($index > 0)
